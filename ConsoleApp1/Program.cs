...
namespace HttpClientSample
{
    class Program
    {
        ...
        static async Task<List<T>> GetDataAsync<T>(string path)
        {
        ...
        static async Task<bool> GetDataAsync()
        {
            Users = await GetDataAsync<User>("users");
            Posts = await GetDataAsync<Post>("posts");
            Comments = await GetDataAsync<Comment>("comments");
            Todos = await GetDataAsync<Todo>("todos");
